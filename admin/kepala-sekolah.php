                    ...
                    <div class="box-body">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Nama</label>
                                <input ype="text" name="nama" class="input-control" placeholder="Nama Kepala Sekolah" value="<?= $d->nama_kepsek ?>" required>
                            </div>

                            <div class="form-group">
                                <label>Sambutan</label>
                                <textarea name="sambutan" class="input-control" placeholder="Sambutan Kepala Sekolah" value="<?= $d->sambutan_kepsek ?>" required></textarea>
                            </div>
                        ...
                        <?php
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if($_FILES['foto_baru']['name'] != ''){
                                    ...
                                    $allowedtype = array('png', 'jpg', 'jpeg', 'heic', 'gif');
