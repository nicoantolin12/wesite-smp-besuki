...
<?php
    ...
    if(mysqli_num_rows($informasi) == 0){
        echo "<script>windows.location='informasi.php'</script>";
    }
                    ...
                    <div class="box-body">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="keterangan" class="input-control" placeholder="Keterangan" value="<?= $p->nama ?>" id="keterangan"></textarea>
                            </div>
