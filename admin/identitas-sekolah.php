                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Alamat</label>
                                <textarea name="alamat" class="input-control" placeholder="Alamat" value="<?= $d->alamat ?>"></textarea>
                            </div>

                            <div class="form-group">
                                <label>Google Maps</label>
                                <textarea name="gmaps" class="input-control" placeholder="Google Maps" value="<?= $d->google_maps ?>"></textarea>
                            </div>
                        ...
                        <?php
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                //tampung dan validasi data logo
                                if($_FILES['logo_baru']['name'] != ''){
                                    ...
                                    $allowedtype_logo = array('png', 'jpg', 'jpeg', 'heic', 'gif');

                                    if(!in_array($formatfile_logo, $allowedtype_logo)){

                                        echo '<div class="alert alert-error">Format Tidak terdaftar</div>';

                                        return false;
                                    
                                    }elseif($filesize_logo > 1000000){

                                        echo '<div class="alert alert-error">Ukuran File Leboh dari 1mb</div>';
                                ...
                                //tampung dan validasi data favicon
                                if($_FILES['favicon_baru']['name'] != ''){
                                    ...
                                    $allowedtype_favicon = array('png', 'jpg', 'jpeg', 'heic', 'gif');
                                    ...
                                    $rename_favicon = $_POST['logo_lama'];
                                }
